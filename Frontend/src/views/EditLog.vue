...
export default {
  ...
  methods: {
    getTracker() {
      let url = "http://127.0.0.1:5000/tracker/" + this.Logdata.tracker_id;
      fetch(url, {
        method: "GET",
    ...
    getLog() {
      ...
      let url = "http://127.0.0.1:5000/log/" + this.log_id;
    ...
    updateLog() {
      ...
      let url = "http://127.0.0.1:5000/update_log/" + this.log_id;
      fetch(url, options)
